...
export const EntityContainer = ({
  ...
  return (
    <div className={"p-4 md:px-10 md:py-6 h-full"}>
      <div
        className={"mx-auto max-w-screen-xl w-full flex flex-col gap-4 h-full"}
      >
        {header}
...
export const EntitySearch = ({
  ...
  return (
    <div className={"relative ml-auto"}>
      <SearchIcon
        className={
          "size-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground"
        }
      />
      <Input
...
export const EntityPagination = ({
  ...
  return (
    <div className={"items-center justify-between gap-x-2 flex w-full"}>
      <div className={"flex-1 text-sm text-muted-foreground"}>
        {page} of {totalPages || 1}
      </div>
      <div className={"flex items-center justify-end space-x-2 py-4"}>
        <Button
          disabled={totalPages === 1 || disabled || page === 1}
          onClick={() => {
...
export const LoadingView = ({ message }: StateViewProps) => {
  return (
    <div
      className={
        "flex justify-center items-center h-full flex-1 flex-col gap-y-4"
      }
    >
