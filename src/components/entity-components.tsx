...
export const EntityContainer = ({children, header, search, pagination}: EntityContainerProps) => {
  ...
  return (
      <div className={"p-4 md:px-10 md:py-6 h-full"}>
        <div className={"mx-auto max-w-screen-xl w-full flex flex-col gap-4 h-full"}>
          {header}
...
export const EntityPagination = ({disabled, totalPages, page, onPageChange}: EntityPaginationProps) => {
  ...
  return (
      ...
      >
        ...
        <div className={"flex items-center justify-end space-x-2 py-4"}>
          <Button disabled={totalPages === 1 || disabled || page === 1}
                  onClick={() => {
